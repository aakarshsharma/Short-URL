...
public class ShortUrlMain {
  ...
  public static void main(String[] args) {
    ...
    //System.out.println("GETURL "+shortUrl.getUrl(url));
    assert(shortUrl.getUrl(url2).equals(shortUrl.getUrl(url4)));
    //System.out.println("GETURL "+shortUrl.getUrl(url2));
    assert(shortUrl.getUrl(url5).equals("http://abc5.com"));
    //System.out.println("GETURL "+shortUrl.getUrl(url5));
    ...
    //System.out.println("NOTICE "+shortUrl.getHitCount("http://abc2.com"));
    // Try to fetch hit count for a non existent long URL, should return 0 
    assert(shortUrl.getHitCount("http://abcn.com").equals(0));
    //System.out.println("NOTICE "+shortUrl.getHitCount("http://abcn.com"));
